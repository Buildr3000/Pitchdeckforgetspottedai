    ...
    <SlideContainer>
      <div className="flex flex-col h-full justify-center">
        ...
        <h2 className="text-3xl md:text-5xl font-['IBM_Plex_Mono',monospace] font-bold mb-10 text-[#564256] text-left leading-tight">
          Notre business model est clair et <span className="text-[#fc814a]">scalable</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div 
                ...
                className="bg-white border border-gray-100 p-8 rounded-[24px] shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow"
            >
            ...
            <motion.div 
                ...
                className="bg-[#564256] border border-[#564256] p-8 rounded-[24px] shadow-sm flex flex-col items-center text-center text-white"
            >
                ...
                <h3 className="font-['IBM_Plex_Mono',monospace] text-2xl text-white font-bold mb-3">Tiers de confiance</h3>
                <p className="text-base text-white/70 font-light mb-8 max-w-sm">Sécurisation des transactions et garantie de publication.</p>
                
                <div className="w-full bg-white/10 rounded-xl p-6 border border-white/10">
                    <div className="text-xs text-white/70 uppercase tracking-wider font-bold mb-2">Service</div>
                    <div className="text-4xl font-['IBM_Plex_Mono',monospace] font-bold text-white">Inclus</div>
                    <div className="text-xs text-white/50 mt-2 uppercase font-bold tracking-wide">Platform</div>
                </div>
            </motion.div>
        </div>
      </div>
